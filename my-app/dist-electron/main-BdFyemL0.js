...
async function connectToMongoDB() {
  try {
    MongoClient = (await import("./index-BbgFuscl.js").then((n) => n.i)).MongoClient;
  ...
  try {
    if (!db) {
      ...
      if (!connected) {
        ...
        return { success: false, error: "MongoDB conenction failed" };
      }
      ;
    }
    const collection = db.collection("users");
    const result = collection == null ? void 0 : collection.insertOne(user);
